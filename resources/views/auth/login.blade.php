                                            ...
                                            <form action="{{ url('/login_user') }}" method="post">
                                                ...
                                                <div class="form-container vertical">
                                                    <div class="form-item vertical">
                                                        ...
                                                        <div>
                                                            <input class="input" type="text" name="email" autocomplete="off" placeholder="Email" value="admin@admin.com">
                                                        </div>
                                                    </div>
                                                    <div class="form-item vertical">
                                                        ...
                                                        <div>
                                                            <span class="input-wrapper">
                                                                <input class="input pr-8" type="password" name="password" autocomplete="off" placeholder="Password" id="input-password">
                                                                <div class="input-suffix-end">
                                                                    <span class="cursor-pointer text-xl" onclick="togglePassword()" id="eye-icon">
                                                                        <svg
                                                                            stroke="currentColor"
                                                                            fill="none"
                                                                            stroke-width="2"
